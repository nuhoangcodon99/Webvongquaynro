...
<div class="container pt-5 pb-5">
    <div class="row">
        <div class="col">
            ...
            <?php if ($windowsLink): ?>
                <p>Link Tải Phiên Bản IOS: <a class="text-dark font-weight-bold"
                        href="../download/Nro Kuroko.ipa">Tại đây</a></p>
            <?php else: ?>
                <p>Link tải phiên bản IOS: <a class="text-dark font-weight-bold"
                                                        href="https://testflight.apple.com/join/xPp36BBJ">Tại đây</a></p>
            <?php endif; ?>
