...
<div class="ant-col ant-col-xs-24 ant-col-sm-24 ant-col-md-24">
    <div class="page-layout-body">
        ...
        <div class="ant-row">
            <div class="row">
                <div class="col">
                    <a href="/" style="color: black" class="ant-col ant-col-24 home_page_bodyTitleList__UdhN_">Quay lại
                        diễn đàn</a>
                </div>
            </div>
        </div>
                                ...
                                <div class="container pt-5 pb-5">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <?php else: ?>
                                                <p>Link tải phiên bản Android: <a class="text-dark font-weight-bold"
                                                        href="https://drive.google.com/file/d/15h61YUFSC8OAc7yXnTdSqC11YjmH72vE/view?usp=sharing">Tại đây</a></p>
                                            <?php endif; ?>
